...
class CRM_Cdntaxreceipts_Task_PDFLetterCommon extends CRM_Contact_Form_Task_PDFLetterCommon {
  ...
  public static function postProcessForm(&$form, $formValues = NULL) {
    ...
    [$contributions, $contacts] = self::buildContributionArray($groupBy, $contributionIDs, $returnProperties, $skipOnHold, $skipDeceased, $messageToken, $task, $separator, false);
    $html = [];
